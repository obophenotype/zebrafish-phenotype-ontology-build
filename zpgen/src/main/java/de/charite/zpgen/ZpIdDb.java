...
public class ZpIdDb {
  ...
  /**
   * Constructs a zp id data base and filling it with previously assigned ids gathered from the
   * given ontology.
   * 
   * @param zp
   */
  ...
  /**
   * Returns the Id (as IRI) of the given owlSomeClassExp. This may be a new one if classExpression
   * was not seen before.
   * 
